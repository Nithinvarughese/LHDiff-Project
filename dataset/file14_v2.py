...
def test_ipynb_diff_with_no_change_single() -> None:
    """Verify that Jupyter notebook diff is skipped when dependencies are missing."""
    ...
    print("Checking output for single notebook...")
...
def test_ipynb_diff_with_no_change_dir(tmp_path: pathlib.Path) -> None:
    ...
    print("Checking output for notebook directory...")
    assert expected_output in result.output
